      ...
      <div class="container">
        <div class="row">
          <div class="col-md-4 col-xs-12">
            <div>
              <img src="assets\images\hb2.jpg" alt="" class="img-fluid wc-image">
            </div>
            <br>
    ...
    <div class="products">
      <div class="container">
        <div class="row">
          <div class="col-md-4 col-xs-12">
            <div>
              <img src="assets/images/hb3.jpg" alt="" class="img-fluid wc-image">
            </div>
            <br>
...
<div class="products">
      <div class="container">
        <div class="row">
          <div class="col-md-4 col-xs-12">
            <div>
              <img src="assets/images/hb4.jpg" alt="" class="img-fluid wc-image">
            </div>
            <br>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-4 col-xs-12">
            <div>
              <img src="assets/images/hb5.jpg" alt="" class="img-fluid wc-image">
            </div>
            <br>
