      ...
      <div class="container">
        <div class="row">
          <div class="col-md-4 col-xs-12">
            <div>
              <img src="assets/images/eye1.jpg" alt="" class="img-fluid wc-image">
            </div>
            <br>
    ...
    <div class="products">
      <div class="container">
        <div class="row">
          <div class="col-md-4 col-xs-12">
            <div>
              <img src="assets/images/eye2.jpeg" alt="" class="img-fluid wc-image">
            </div>
            <br>
...
<div class="products">
      <div class="container">
        <div class="row">
          <div class="col-md-4 col-xs-12">
            <div>
              <img src="assets/images/eye3.jpg" alt="" class="img-fluid wc-image">
            </div>
            <br>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-4 col-xs-12">
            <div>
              <img src="assets/images/eye4.jpg" alt="" class="img-fluid wc-image">
            </div>
            <br>
